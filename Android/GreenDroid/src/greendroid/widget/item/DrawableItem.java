...
public class DrawableItem extends TextItem {
     ...
     * @hide
     */
    public DrawableItem(boolean even) {
        this(null, even);
    }
     ...
     */
    public DrawableItem(String text, boolean even) {
        this(text, 0, even);
    }
     ...
     */
    public DrawableItem(String text, int drawableId, boolean even) {
        super(text);
    ...
    public ItemView newView(Context context, ViewGroup parent) {
    	if(this.evenRow) {
    		...
    		return createCellFromXml(context, R.layout.gd_drawable_item_view_odd, parent);
    	}
    }
